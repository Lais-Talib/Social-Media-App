      ...
      <div className='flex flex-col md:flex-row items-start gap-6'>
        ...
        <div className='w-full pt-16 md:pt-0 md:pl-36'>
             <div className='flex flex-col md:flex-row items-start justify-between'>
                ...
                {/* If User is not on others profile that means he is opeining his profile so we will give edit button */}
                {!profileId && 
                <button  onClick={()=> setShowEdit(true)} className='flex-items-center gap-2 border border-gray-300 hover:bg-gray-50 px-2 rounded-lg font-medium transition-colors mt-4 md:mt-0 cursor-pointer' >
